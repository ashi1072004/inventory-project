...
INSERT INTO `admin_order` (`order_id`, `invoice`, `pcode`, `pname`, `pprice`, `pqty`, `ptprice`, `aemail`) VALUES
(1, '98192785480', '019385', 'HP Elitebook 830 G5', 78000, 6, 468000, 'admin@gmail.com'),
(2, '98192785480', '0218942', 'Honda CB 125F', 380900, 4, 1523600, 'admin@gmail.com'),
(3, '98192785480', '019583', 'HP 11 inch Tablet PC', 55000, 7, 385000, 'admin@gmail.com'),
(4, '98192785480', '0708755', '141000003X', 2050, 4, 8200, 'admin@gmail.com'),
(5, '0377593', '019385', 'HP Elitebook 830 G5', 78000, 3, 234000, 'admin@gmail.com'),
(6, '0377593', '0534352', 'Dell XPS 15 9520 Core i7', 604999, 2, 1209998, 'admin@gmail.com'),
(7, '0377593', '0892435', 'SMART ATHLETIC SHOES', 5000, 1, 5000, 'admin@gmail.com'),
(8, '0377593', '9886466', 'Lenovo Yoga Tab 13', 95999, 3, 287997, 'admin@gmail.com'),
(12, '0376723685', '098764', 'Metro-10850198', 1899, 4, 7596, 'admin@gmail.com'),
(13, '0376723685', '97657636', 'BMW X5 Series xDrive45e', 59000000, 6, 354000000, 'admin@gmail.com'),
(14, '36785347985', '0987654321', 'Audi Q7 2995 cc', 47000000, 10, 470000000, 'admin@gmail.com'),
(15, '36785347985', '0685432434', '110540090X', 5690, 4, 22760, 'admin@gmail.com'),
(16, '36785347985', '12397589', 'Honda Accord 1.5L VTEC Turbo', 15499000, 4, 61996000, 'admin@gmail.com'),
(17, '8783458002', '0987654321', 'Audi Q7 2995 cc', 47000000, 5, 235000000, 'admin@gmail.com'),
(18, '8783458002', '8643467598', 'Audi TT RS Roadster', 19400000, 2, 38800000, 'admin@gmail.com');
...
(3, 'Car', 'BMW Car, Honda City Car.', '2023/11/09'),
...
(12, 'Chairs', 'greyuyiuh...dfdsfd..dfs', '2023/11/13');
...
(7, 'Pair', 'More than 1 piece', '2023/11/13');
...
INSERT INTO `pos` (`posid`, `invoice`, `csname`, `cmob`, `tprice`, `ostatus`) VALUES
(3, '98192785480', 'Jackson Meyer', '+1 (796) 575-4119', 2384800, 'Pending'),
(4, '0377593', 'JGBeuijkef', '+1 (796) 997-8734', 1736995, 'Pending'),
(6, '0376723685', 'Jackson Meyer', '+1 (796) 575-4119', 354007596, 'complete'),
(7, '36785347985', 'KJFhg dsfhuJH', '+1 (674) 548-3678', 532018760, 'complete'),
(9, '8783458002', 'JDA JHGW', '+1 (105) 832-7834', 273800000, 'Pending');
...
(5, 3, 1, 2, 6, '8643467598', 'Audi TT RS Roadster', '2480 cc, Automatic, Petrol, 6 Airbags, Rear Central Control, Heated Seats, Navigation, Climate Control, Cruise Control, Traction Control', 19000000, 19400000, 3, 'a:2:{i:0;s:9:\"93044.jpg\";i:1;s:9:\"78897.png\";}', 'offline', '2023/07/11'),
...
(7, 3, 7, 2, 7, '12397589', 'Honda Accord 1.5L VTEC Turbo', '1498 cc, Automatic, Petrol, 6 Airbags, Sun Roof, Moon Roof, Rear AC Vents, Heated Seats, Navigation, Push Start', 15400000, 15499000, 6, 'a:4:{i:0;s:9:\"30474.jpg\";i:1;s:9:\"38183.jpg\";i:2;s:9:\"90082.jpg\";i:3;s:9:\"31157.jpg\";}', 'offline', '2023/07/11'),
...
(50, 8, 16, 8, 3, '076543867865', 'Harper Flynn', 'Eligendi similique u', 95, 100, 18, 'a:2:{i:0;s:9:\"19733.jpg\";i:1;s:9:\"51945.jpg\";}', 'offline', '2023/11/14'),
(55, 4, 17, 2, 2, '686658643856', 'Alden Dickson', 'Sit ut eu quae dolor', 42, 235, 7, 'a:2:{i:0;s:9:\"12525.png\";i:1;s:9:\"80943.png\";}', 'online', '2023/11/14');
...
(1, 3, 'Audi', 'This is a Audi Car description', '2023/11/14'),
...
(8, 4, 'Suzuki', 'This is a Suzuki bike description.', '2023/11/14'),
...
(12, 7, 'IPhone', 'This is a IPhone mobile description.', '2023/11/13'),
...
(21, 4, 'Road Prince', 'This is a Road Prince Bike description.', '2023/11/13');
...
(5, 'Robert Benn', 'jojonuga@mailinator.com', '+1 (365) 111-8445', '2023/11/13'),
...
(8, 'Anastasia Mcpherson', 'pasu@mailinator.com', '+1 (407) 888-9799', '2023/11/13'),
(9, 'Chancellor Rutledge', 'qihek@mailinator.com', '+1 (648) 326-8159', '2023/11/13'),
(13, 'Hermione Horn', 'casefusy@mailinator.com', '+923697844686', '2023/11/11'),
(14, 'Maya Brewer', 'saho@mailinator.com', '+92 334 5724899', '2023/11/11');
...
INSERT INTO `user` (`uid`, `ufname`, `ulname`, `uemail`, `umob`, `country`, `state`, `city`, `add1`, `add2`, `pt_code`, `upass`, `ucpass`, `ustatus`, `udate`) VALUES
(1, 'Talon Warren', 'Dominic Pollard', 'tubysus@mailinator.com', '+1 (738) 621-3475', 'Nobis ullam officiis', 'Aspernatur culpa et ', 'Fugiat culpa laboru', 'Minima voluptatem co', 'Voluptate est rerum ', '22', 'Pa$$w0rd!', 'Pa$$w0rd!', 'Pending', '2023/12/07'),
(2, 'Tucker England', 'Emerald Prince7834', 'myvanyn@mailinator.com', '+1 (911) 683-3767', 'Voluptatibus omnis n', 'Dolorem deserunt off', 'Exercitation quam mo', 'Voluptatem unde cons', 'Impedit perspiciati', '6', 'Pa$$w0rd!', 'Pa$$w0rd!', 'Confirmed', '2023/12/07'),
(3, 'Nina Paul', 'Kathleen Ward', 'pojogetu@mailinator.com', '+1 (241) 919-6808', 'Eiusmod non in omnis', 'Quis iste dicta sed ', 'Provident est even', 'Numquam velit adipis', 'Rerum vero ut optio', '61', 'Pa$$w0rd!', 'Pa$$w0rd!', 'Confirmed', '2023/12/08'),
(5, 'Pearl Reynolds', 'Abra Fields', 'fuluc@mailinator.com', '+1 (639) 973-6893', 'Odio nisi in qui ten', 'Facilis magna nihil ', 'Tempor vel incididun', 'Minima cupidatat sed', 'Quis dolores dolore ', '10046', 'Pa$$w0rd!er', 'Pa$$w0rd!er', 'Confirmed', '2023/12/12'),
(6, 'Amity Larsen', 'Talon Hayes', 'pekiz@mailinator.com', '+1 (499) 413-8963', 'Qui sapiente impedit', 'Incidunt et dolorum', 'Dolores elit quia e', 'Voluptas voluptas ve', 'Rerum quaerat irure ', '46744', 'Pa$$w0rd!dh', 'Pa$$w0rd!dh', 'Confirmed', '2023/12/12'),
(7, 'Holmes Mays', 'Quemby Callahan', 'bojo@mailinator.com', '+1 (601) 435-5765', 'Minus consequatur q', 'Sit non id esse eu', 'In soluta sequi porr', 'Minim reiciendis odi', 'Repudiandae quia eiu', '54567', 'Pa$$w0rd!cv', 'Pa$$w0rd!cv', 'Pending', '2023/12/12');
...
--
ALTER TABLE `add_to_cart`
  MODIFY `aid` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `admin_order`
  MODIFY `order_id` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `pos`
  MODIFY `posid` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `subcategory`
  MODIFY `subid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `supplier`
--
ALTER TABLE `supplier`
  MODIFY `supid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `uid` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
