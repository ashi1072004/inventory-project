...
<div class="shopping-cart section">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<!-- Shopping Summery -->
				<button id="empty" class="btn right">Empty Cart</button>
...
<script>
	$(document).ready(function() {
		...
		$(document).on("click", ".plus", function() {
			var aqty = Number($(this).closest("tr").find("#aqty").val());
			aqty = aqty + 1;
			$(this).closest("tr").find("#aqty").val(aqty);
			showCart();
		...
		function showCart() {
			$.ajax({
				...
				success: function(res) {
					res = JSON.parse(res);
					// alert(res);
					$("#cart-table").html(res.output1);
					$("#total").html(res.output2);
				}
			});
		}
	});
