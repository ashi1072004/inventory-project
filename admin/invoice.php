...
$sql = "SELECT * FROM `pos` WHERE `invoice`='$invoice' ";
              ...
              <div class="row">
                <div class="col-md-6">
                  <address>
                    ...
                    <?php echo $fetch['csname'] ?><br>
                    <?php echo $fetch['cmob'] ?><br>
                  </address>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row mt-4">
                ...
                <div class="col-lg-4 text-right">
                  <div class="invoice-detail-item">
                    ...
                    <div class="invoice-detail-value">Rs. <?php echo $fetch['tprice'] ?></div>
                  </div>
                  <!-- <div class="invoice-detail-item">
