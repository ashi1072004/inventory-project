          ...
          <div class="card">
            <form id="form">
              <div class="card-header">
                ...
                <a class="btn btn-primary text-right" href="./view-product.php">Back</a>
              </div>
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select id="psubcat" class="form-control" name="psubcat" aria-describedby="invalid-psubcat" required="">
                    ...
                    ?>
                        <option value="<?php echo $sfetch['subid'] ?>" selected>
                ...
                <div class="form-group">
                  ...
                  <select id="psup" class="form-control" name="psup" aria-describedby="invalid-psup" required="">
                    ...
                    ?>
                        <option value="<?php echo $supfetch['supid'] ?>" selected>
                ...
                <input type="hidden" class="form-control" name="pid" value="<?php echo $fetch['pid'] ?>">
                <div class="form-group">
                  <label>Product Code</label>
                  <input type="text" id="pcode" class="form-control" name="pcode" value="<?php echo $fetch['pcode'] ?>" aria-describedby="invalid-pcode" required="">
                  <small id="invalid-pcode" class="form-text text-danger"></small>
                </div>
                <div class="form-group">
                  <label>Product Name</label>
                  <input type="text" id="pname" class="form-control" name="pname" value="<?php echo $fetch['pname'] ?>" aria-describedby="invalid-pname" required="">
                  <small id="invalid-pname" class="form-text text-danger"></small>
                </div>
                <div class="form-group">
                  <label>Product Description</label>
                  <textarea id="pdes" class="form-control" name="pdes" aria-describedby="invalid-pdes" required=""><?php echo $fetch['pdes'] ?></textarea>
                  <small id="invalid-pdes" class="form-text"></small>
                </div>
                <div class="form-group">
                  <label>Product Cost Price</label>
                  <input type="number" id="pcost" class="form-control" name="pcost" value="<?php echo $fetch['pcost'] ?>" aria-describedby="invalid-pcost" required="">
                  <small id="invalid-pcost" class="form-text text-danger"></small>
                </div>
                <div class="form-group">
                  <label>Product Sale Price</label>
                  <input type="number" id="psale" class="form-control" name="psale" value="<?php echo $fetch['psale'] ?>" aria-describedby="invalid-psale" required="">
                ...
                <div class="form-group">
                  ...
                  <select id="pmes" class="form-control" name="pmes" aria-describedby="invalid-pmes" required="">
                    ...
                    ?>
                        <option value="<?php echo $mfetch['mid'] ?>" selected>
                ...
                <div class="form-group">
                  ...
                  <input type="number" id="pstock" class="form-control" name="pstock" value="<?php echo $fetch['pstock'] ?>" aria-describedby="invalid-pstock" required="">
        ...
        $.ajax({
          ...
          success: function(res) {
            ...
            if (res == 1) {
              ...
              Toast.fire({
                icon: 'success',
                title: 'Product Updated with New Pics!'
              });
            } else if (res == 3) {
              Toast.fire({
                icon: 'error',
              ...
              Toast.fire({
                icon: 'success',
                title: 'Product Updated with Old Pics!'
              });
            } else {
              Toast.fire({
                icon: 'warning',
